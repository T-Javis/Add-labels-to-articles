...
def with_synoymes_meal():
	km_server=SessionServer(os.path.join(servers_path, 'create_test_withsyn_meal')) #--索引
	article_db=db.query('select * from article_all')

	min_similarity=0.1 #0.2
	max_results=5 #2
	#db.execute('update article_all set meal=null') #initial
	...
	#for i in range(0,3):
		...
		for l in article_label_list:
			...
			#print(article_id)
			#print(label_id)
			#db.execute('update article_all set meal=%s where id=%s',(label_list_sql,article_id))
			db.execute('update article_all set meal_sim=%s where id=%s',(label_list_sql_sim,article_id))
			db.execute('update article_all set meal_sim_json=%s where id=%s',(label_list_sql_sim_json,article_id))
...
def without_synoymes_meal():
	km_server=SessionServer(os.path.join(servers_path, 'create_test_withoutsyn_meal')) #--索引
	article_db=db.query('select * from article_all')

	min_similarity=0.1 #0.3
	max_results=5 #2
	#db.execute('update article_all set meal_temp=null') #initial
	...
	for i in range(0,len(article_db)):
		...
		for l in article_label_list:
			...
			#print(article_id)
			#print(label_id)
			#db.execute('update article_all set meal_temp=%s where id=%s',(label_list_sql,article_id))
			db.execute('update article_all set meal_temp_sim=%s where id=%s',(label_list_sql_sim,article_id))
			db.execute('update article_all set meal_temp_sim_json=%s where id=%s',(label_list_sql_sim_json,article_id))
		#print(label_list_sql)
		#print('-'*20)
	return None
...
def with_synoymes_wear():
	km_server=SessionServer(os.path.join(servers_path, 'create_test_withsyn_wear')) #--索引
	article_db=db.query('select * from article_all')

	min_similarity=0.1 #0.2
	max_results=5 #2
	#db.execute('update article_all set wear=null') #initial
	...
	#for i in range(0,3):
		...
		for l in article_label_list:
			...
			#print(article_id)
			#print(label_id)
			#db.execute('update article_all set wear=%s where id=%s',(label_list_sql,article_id))
			db.execute('update article_all set wear_sim=%s where id=%s',(label_list_sql_sim,article_id))
			db.execute('update article_all set wear_sim_json=%s where id=%s',(label_list_sql_sim_json,article_id))
		#print(label_list_sql)
		#print('-'*20)
	return None
...
def without_synoymes_wear():
	km_server=SessionServer(os.path.join(servers_path, 'create_test_withoutsyn_wear')) #--索引
	article_db=db.query('select * from article_all')

	min_similarity=0.1 #0.3
	max_results=5 #2
	#db.execute('update article_all set wear_temp=null') #initial
	...
	for i in range(0,len(article_db)):
		...
		for l in article_label_list:
			...
			#print(article_id)
			#print(label_id)
			#db.execute('update article_all set wear_temp=%s where id=%s',(label_list_sql,article_id))
			db.execute('update article_all set wear_temp_sim=%s where id=%s',(label_list_sql_sim,article_id))
			db.execute('update article_all set wear_temp_sim_json=%s where id=%s',(label_list_sql_sim_json,article_id))
		#print(label_list_sql)
		#print('-'*20)
	return None
...
'''
def combine():	
	test_db=db.query('select * from article_all')
	for i in range(0,len(test_db)):
		...
		if meal_label_list==None and wear_label_list==None:
			...
			db.execute('update article_all set meal_wear=%s where id=%s',(meal_wear,article_id))
	return None
'''
...
def combine_meal_wear():  #combine meal and wear label
	...
	for i in range(0,len(article_db)):
		...
		db.execute('update article_all set meal_wear_sim=%s where id=%s',(meal_wear_list_label_norepeat_dic_sort,article_id))
		db.execute('update article_all set meal_wear_sim_json=%s where id=%s',(meal_wear_list_label_norepeat_dic_sort_json,article_id))
...
def wordcloud_fre():  #tf-idf result
	article_db=db.query('select * from article_all')
	db.execute('update article_all set word_fre=null') #initial
	...
	#for i in range(0,3):
		...
		db.execute('update article_all set word_fre=%s where id=%s',(top_word_dic_sort,article_id))
		db.execute('update article_all set word_fre_json=%s where id=%s',(top_word_dic_sort_json,article_id))
		print('-'*30)
...
def label_filter():
	...
	for i in range(0,len(article_db)):
		...
		#print(label_update)
		db.execute('update article_all set label_update=%s where id=%s',(label_update,article_id))
'''
...
def label_select():
	...
	for i in range(0,len(article_db)):
		...
		db.execute('update article_all set label_update_json=%s where id=%s',(label_update_json,article_id))
